          ...
          >
            <OwlCaraousel
              ...
              onChanged={(event) => {
                ...
                const realIndex =
                  ((event.item.index - clones / 2 + slideCount) % slideCount) +
                  1;
              ...
              <div className="testimonial-item">
                <div className="testimonial-item-inner">
                  <p>
                    ...
                    His ability to craft bespoke interactions and solve complex
                    problems with lightweight code has been instrumental in
                    delivering standout work for our clients. Beyond this, he's
                    built sophisticated experiences using React and WebGL,
                    demonstrating both technical range and a true eye for
                    web-based storytelling. From project inception and scoping,
                    to architecture through to execution, his consultancy,
                    foresight and ability to evolve and adapt has consistently
                    led to the creation of quality work.
                  </p>
              ...
              <div className="testimonial-item">
                <div className="testimonial-item-inner">
                  <p>
                    ...
                    deep-thinker who can rise to any new occasion or challenge.
                    Whether it be Webflow, WebGL, React, Blender or Unity — you
                    name it, Josh has that rare ability to learn new programming
                    languages or tools with ease. I would describe him as an
                    independent learner who can lead his own projects and the
                    people around him. The exact type of thinker you need for
                    Innovation to occur.
                  </p>
                  <div className="author d-flex align-items-center">
