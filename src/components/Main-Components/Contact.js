          ...
          <div className="section-header">
            <div className="new-header">
              <h1 className="scroll-animation" data-aos="fade-up">
                Let's Work <span className={"bold"}>Together</span>
              </h1>
              ...
              <div className="col-md-12">
                {status === "success" && (
                  <div className="submit-msg success">
                    <span className={"green"}>Message received!</span>
                    <br />I will get back to you as soon as possible!
                  </div>
                )}
                {status === "error" && (
                  <div className="submit-msg error">
                    <span className="red">Oops, something went wrong.</span>
                    <br />
                    Please try again or reach out via my email directly:{" "}
                    <a
                      className={"white"}
                      href={"mailto:hello@joshwaay.dev"}
                      target={"_blank"}
                    >
                      hello@joshwaay.dev
                    </a>
